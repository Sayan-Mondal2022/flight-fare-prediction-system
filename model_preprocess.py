...
def preprocess_custom_input(input_df, feature_columns):
    ...
    processed_df['Class'] = processed_df['Class'].map(class_priority)
    ...
    processed_df['Total_stops'] = processed_df['Total_stops'].map(stops_priority)
    ...
    processed_df['Arrival'] = processed_df['Arrival'].map(arrival_priority)
    ...
    processed_df['Departure'] = processed_df['Departure'].map(departure_priority)
    ...
    processed_df['Journey_day'] = processed_df['Journey_day'].map(days_priority)
